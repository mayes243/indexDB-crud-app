      ...
      <div className="col-md-6" style={{ overflowX: "auto" }}>
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "5px" }}>
            ...
            />
            <button type="button" className="btn btn-info mt-2" onClick={() => getAgeWiseData()}>
              Filter
            </button>
            <button type="button" className="btn btn-secondary mt-2" onClick={() => getAllData()}>
              Clear
            </button>
          </div>
          <button
              ...
              return (
                <tr key={user?.id}>
                  ...
                  <td>
                    ...
                    <button className="btn btn-danger" onClick={() => deleteSelected(user)}>
                      Delete
                    </button>
                  </td>
                </tr>
      ...
      <div className="col-md-6">
        {editUser || addUser ? (
          <div className="card" style={{ padding: "20px" }}>
            <p style={{ fontWeight: "500" }}>{editUser ? "Update User" : "Add User"}</p>
            ...
            <div className="form-group">
              <button className="btn btn-primary mt-2" type="submit" onClick={handleSubmit}>
                {editUser ? "Update" : "Add"}
              </button>
            </div>
          </div>
